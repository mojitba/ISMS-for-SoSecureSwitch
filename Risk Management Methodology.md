...
| **Reference:** | \[ISO/IEC 27001:2022 Clauses 6.1.2,6.1.3\]|
| **Owner:** | \[ISMS Manager\] |
...
**5\. Risk Evaluation: Determine Risk Levels**
...
| :---- | :---- | :---- |
| **15 \- 25** | **High** | **Mitigate AND Accept.** Treatment required. A formal Risk Treatment Plan (RTP) must be created. Acceptance of a 'High' risk requires formal, written approval from Top Management (CEO). |
| **6 \- 12** | **Medium** | **Mitigate AND Accept.** Treatment is required unless formally accepted by the Asset Owner and ISMS Manager. |
